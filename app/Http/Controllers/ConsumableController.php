...
class ConsumableController extends Controller
{
    ...
    {
        return ConsumableService::GetAll($this->company_uuid);
    }
    ...
    public function store(Request $request)
    {
        ...
        $response = ConsumableService::Register($fieldset, $this->company_uuid);
    ...
    public function update(Request $request, string $uuid)
    {
        ...
        return ConsumableService::edit($uuid, $fieldset, $this->company_uuid);
    }
    ...
    {
        $response = ConsumableService::delete($uuid, $this->company_uuid);
        return $response;
    }
}
